...
<script language = "javascript">
	...
	function chk()
	{	if(document.idxfrm.sblid.value==""){ alert("โปรดเลือกชื่อหลักสูตร"); return false; }
		if(document.idxfrm.sbgid.value==""){ alert("โปรดเลือกชื่อกลุ่มวิชา"); return false; }
		if(document.idxfrm.sbid.value==""){ alert('โปรดเลือกชื่อวิชา :'); return false;}
		return true;	
	}
</script>
	</head>
			...
			<img border="0" src="../<? echo $_SESSION['vvphoto']; ?>" width="64" height="80"></td>
				...
				<tr>
					...
					<table border="0" width="100%" cellspacing="1" cellpadding="3" bgcolor="#F2CEB3">
						<tr>
							...
							หลักสูตร</b></font><b><span style="font-size: 10pt">
				...
				<? }  ?>	
						...
						<tr>
							<td width="10%"><b>
							<p align="right">
							<font color="#003366" style="font-size: 10pt">กลุ่มวิชา</font><span style="font-size: 10pt"> <font color="#003366"> :</font></span></td>
							<td width="25%" id="tbsbgid" ><p align="left">
								...
								size="1" style="font-family: Tahoma; font-size: 13; color: #4B3D34" tabindex="2">
									<option>_เลือกชื่อกลุ่มวิชา หากไม่มีกรุณาปรับปรุงชื่อกลุ่มวิชา</option>
							...
							<td width="17%" id="tdsbid" >
								<select name='sbid' size="1" style="font-family: Tahoma; font-size: 13; color: #4B3D34" tabindex="3">
									<option>เลือกชื่อวิชา หากไม่มีกรุณาปรับปรุงชื่อวิชา</option>
...
background="images/laithai.jpg">	
	<tr>
		<td align="center" width="2%" bgcolor="#FF6600" height="24">
			<font color="#FFFFFF"><b><span style="font-size: 12pt">ข้อ<span lang="en-us">/</span>เฉลย</span></b>
