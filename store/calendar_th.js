...
function f_tcalGenerDate (d_date) {
	return ((d_date.getDate() < 10 ? '0' : '') + d_date.getDate()+ "/"+ (d_date.getMonth() < 9 ? '0' : '') + (d_date.getMonth() + 1)  + "/"+ (d_date.getFullYear()-0+543)
...
function f_tcalUpdate (d_date) {
	...
	var a_class, s_html = '<table class="ctrl"><tbody><tr>'
		...
		+ this.a_tpl.months[d_date.getMonth()] + ' ' + (d_date.getFullYear()-0+543)
